...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <section className="relative tl-hero-bg text-neutral-900">
        <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden>
          <div className="absolute inset-0 tl-hero-gradient" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto min-w-0 px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="max-w-3xl mx-auto min-w-0 px-1 text-center sm:px-2">
            <motion.h1
              initial={{ opacity: 0, y: 12 }}
              animate={{ opacity: 1, y: 0 }}
              className="font-sans font-bold tracking-tight text-neutral-900 text-balance break-words mb-4 [font-size:clamp(1.75rem,5vw+0.5rem,3.75rem)] [line-height:1.12]"
            >
              {t("home.hero.title")}
            </motion.h1>
            <motion.p
              ...
              className="text-neutral-700 mb-10 text-balance break-words [font-size:clamp(1rem,2.5vw+0.5rem,1.375rem)] [line-height:1.45]"
            >
            ...
            >
              ...
              <Button
                type="submit"
                size="lg"
                className="sm:w-auto w-full rounded-xl px-8 h-12 bg-[hsl(var(--brand-royal))] text-white hover:bg-[hsl(var(--brand-royal))]/90 font-semibold shadow-md"
              >
      ...
      {showDiscovery ? (
        <section className="py-12 bg-white border-y border-neutral-200/80 min-w-0 max-w-full overflow-x-hidden">
          <div className="max-w-7xl mx-auto w-full min-w-0 px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
              <h2 className="font-sans text-2xl sm:text-3xl font-bold text-neutral-900 text-balance break-words min-w-0">
            ...
            <div className="flex min-w-0 gap-4 overflow-x-auto overflow-y-hidden pb-2 [scrollbar-width:thin]">
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8 bg-[hsl(var(--brand-cream))]/80 overflow-visible">
        <div className="max-w-7xl mx-auto min-w-0">
          <div className="rounded-[2rem] bg-white/90 border border-neutral-200/80 shadow-sm overflow-visible">
            <div className="grid lg:grid-cols-2 gap-10 items-center p-8 lg:p-12 min-w-0">
              <div className="min-w-0 overflow-visible">
                <h2 className="font-sans font-bold text-neutral-900 mb-4 text-balance break-words leading-tight [font-size:clamp(1.5rem,4vw+0.75rem,2.25rem)]">
                  {t("home.cta.title")}
                </h2>
